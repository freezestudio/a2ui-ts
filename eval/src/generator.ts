 ...
 *
 * 架构：
 * - Generator 抽象基类 — 定义生成流程（已下沉到 @freezestudio/a2ui-agent，此处 re-export）
 * - MockGenerator — 返回预定义 JSON，用于测试
 * - 实际的 LLM 生成器需继承 Generator 实现 callLLM 方法
 */

import { Generator } from '@freezestudio/a2ui-agent';
import type { GeneratedResult, ModelConfig } from '@freezestudio/a2ui-agent';

export { Generator } from '@freezestudio/a2ui-agent';
