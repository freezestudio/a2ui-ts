 ...
 * 已下沉到 @a2ui/agent，此处 re-export 保持公共 API 兼容。
 */

import type { TestPrompt, GeneratedResult, ModelConfig } from '@a2ui/agent';

export type { TestPrompt, GeneratedResult, ModelConfig } from '@a2ui/agent';
